...
urlpatterns = [
    ...
    path('turmas/<int:turma_id>/planilha/notas.pdf', views.exportar_notas_pdf, name='exportar_notas_pdf'),
    path('turmas/<int:turma_id>/planilha/frequencia.pdf', views.exportar_frequencia_pdf, name='exportar_frequencia_pdf'),
    path('turmas/<int:turma_id>/relatorio-final.pdf', views.relatorio_final, name='relatorio_final'),
